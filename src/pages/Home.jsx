                ...
                <div className="w-full lg:w-6/12 text-center lg:text-left">
                    <div className="home-info">
                        <div className="text mb-7">
                            <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center justify-center lg:justify-start gap-3 mb-6">
                                <h1 className="text-white text-2xl sm:text-3xl font-bold">I am Yash</h1>
                                <div className="flex flex-wrap justify-center lg:justify-start gap-2">
                                    <span className="inline-flex items-center rounded-lg bg-slate-900 px-3 py-2 text-base sm:text-lg font-semibold text-white">
                                        Google Ads Expert
                                    </span>
                                    <span className="inline-flex items-center rounded-lg bg-slate-900 px-3 py-2 text-base sm:text-lg font-semibold text-white">
                                        Web Developer
